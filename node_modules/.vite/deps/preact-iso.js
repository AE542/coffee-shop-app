...
// node_modules/preact-iso/router.js
var push;
...
// node_modules/preact-iso/lazy.js
function lazy(load) {
  let p, c;
  return (props) => {
    const [, update] = h(0);
...
// node_modules/preact-iso/hydrate.js
var initialized;
...
// node_modules/preact-iso/index.js
function prerender(vnode, options) {
  return import("./prerender-LDJMSHVU.js").then((m) => m.default(vnode, options));
}
export {
  ErrorBoundary,
  LocationProvider,
